      ...
      <section className="bg-emerald-950 py-20 text-white">
        <div className="container mx-auto flex flex-col items-center text-center">
                <h1 className=" text-6xl font-bold tracking-tighter">
                    <span className='sm:text-7xl md:text-[140px] lg:text-[200px] lg:mr-[170px]'>about our</span>
                    <br />
                    <span className='lg:ml-[370px] sm:text-7xl md:text-[140px] lg:text-[200px] mt-10'>agency</span>
                </h1>
