  ...
  return (
    <>
      <main>
          ...
          <div className="container mx-auto flex flex-col items-center text-center">
            <div className="flex flex-col items-center justify-center">
              <h1 className="text-6xl font-bold tracking-tighter">
                <span className='sm:text-7xl md:text-[180px] lg:text-[250px] lg:mr-[250px]'>Web</span>
                <br />
                <span className='lg:ml-[400px] sm:text-7xl md:text-[180px] lg:text-[200px] mt-10'>Design</span>
              </h1>
            </div>
        ...
        <OtherServices currentService="Web Development" />
      </main>
    </>
  );
}
