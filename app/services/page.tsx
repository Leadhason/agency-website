      ...
      <section className="bg-emerald-950 py-24 text-white md:py-32">
        <div className="container mx-auto flex flex-col items-center text-center">
            <h1 className="text-6xl font-bold tracking-tighter">
                <span className='sm:text-7xl md:text-[140px] lg:text-[180px] lg:mr-[190px]'>Services</span>
                <br />
                <span className='lg:ml-[500px] sm:text-7xl md:text-[140px] lg:text-[180px] mt-10'>we offer</span>
            </h1>
