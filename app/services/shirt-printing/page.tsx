  ...
  return (
    <>
      <main>
          ...
          <div className="container mx-auto flex flex-col items-center text-center">
            <div className="flex flex-col items-center justify-center">
              <h1 className="text-6xl font-bold tracking-tighter">
                <span className='sm:text-7xl md:text-[180px] lg:text-[200px] lg:mr-[500px]'>Shirt</span>
                <br />
                <span className='lg:ml-[400px] sm:text-7xl md:text-[180px] lg:text-[200px] mt-10'>Printing</span>
              </h1>
            </div>
            <div className="items-center justify-center lg:justify-bottom w-full">
              <p className="max-w-lg text-lg font-medium text-justify px-20 mt-6 lg:ml-[50px] text-zinc-300">
        ...
        <OtherServices currentService="Shirt Printing" />
      </main>
    </>
  );
}
