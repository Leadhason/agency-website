          ...
          <SheetContent side="right" className="w-full border-none bg-emerald-950">
            <nav className="flex h-full w-full flex-col items-center justify-center text-white">
              <div className="flex flex-col items-center gap-8">
                <Link href="/" className="text-5xl font-light transition-colors hover:underline">
                  Home
                </Link>
                <Link href="/about" className="text-5xl font-light transition-colors hover:underline">
                  About
                </Link>
                <Link href="/services" className="text-5xl font-light transition-colors hover:underline">
                  Services
                </Link>
                <Link href="/projects" className="text-5xl font-light transition-colors hover:underline">
                  Our Work
                </Link>
                <Link href="/contact" className="text-5xl font-light transition-colors hover:underline">
                  Contact
                </Link>
              </div>
            </nav>
